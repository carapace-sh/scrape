"""Scrape youtube-dl (optparse-based) for carapace-spec generation."""
import json
import os
import sys
import optparse
...
def main():
    ...
    cli_name = os.environ.get('CLI_NAME', 'youtube-dl')
    ...
    result = {
        ...
        "commands": {
            "": {
                "description": "A command-line program to download videos from YouTube and other video sites",
                "arguments": arguments,
                "group": "",
            }
        },
